Feature: Import Forecast Data
    ...
    Scenario: Imported city from data
      ...
      When I import the data from file ../config/lewisham-forecast.json
      Then I should only have City object with name lewisham

    Scenario: Imported forecasts for city

      When I import the data from file ../config/lewisham-forecast.json
      Then I should have forecast objects for city lewisham